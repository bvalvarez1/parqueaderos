...
/**
 * REST controller for managing {@link ec.loja.domain.Functionality}.
 */
@RestController
@RequestMapping("/api")
public class FunctionalityResource {
    ...
    public FunctionalityResource(FunctionalityService functionalityService, FunctionalityRepository functionalityRepository) {
    ...
    public ResponseEntity<List<FunctionalityDTO>> getAllFunctionalities(Pageable pageable) {
        log.debug("REST request to get a page of Functionalities");
        Page<FunctionalityDTO> page = functionalityService.findAll(pageable);
