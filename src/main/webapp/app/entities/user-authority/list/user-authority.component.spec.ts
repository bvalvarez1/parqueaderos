...
describe('Component Tests', () => {
  describe('UserAuthority Management Component', () => {
    let comp: UserAuthorityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserAuthorityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userAuthorities?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
