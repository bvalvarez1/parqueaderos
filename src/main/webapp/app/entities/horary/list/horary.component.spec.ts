...
describe('Component Tests', () => {
  describe('Horary Management Component', () => {
    let comp: HoraryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HoraryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.horaries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
