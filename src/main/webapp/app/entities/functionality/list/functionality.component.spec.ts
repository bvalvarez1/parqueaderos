...
describe('Component Tests', () => {
  describe('Functionality Management Component', () => {
    let comp: FunctionalityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FunctionalityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.functionalities?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
